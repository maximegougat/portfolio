    ...
    <section id="accueil" className="relative min-h-screen flex flex-col items-center justify-center px-4">
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          <br/>
          <br/>
            Passionné par l'immobilier et la bourse, et fort d'une expérience entrepreneuriale dans la restauration (<a className="text-primary font-bold" href="https://www.biss-app.fr" target="_blank" rel="noopener noreferrer">Biss'App</a>), je souhaite mettre mon expérience à profit pour mener à bien mon projet professionnel : devenir chargé de clientèle de professionnels ou chargé de clientèle patrimoniale.
          </p>
